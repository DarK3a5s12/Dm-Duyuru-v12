...
var statuses = [`VariantCraft`];
var timers = 2;
const owners = ["781513444078649394"];//botu kullanmak için sahip_id girmeyi unutmayın
...
client.login(`MTE5OTQxMTU5MzU0NTUzNTU2OQ.GQ_Ddb.wkaIWtBYeDvBhb7g8p4_wVSHGYuvW1CAAG2AU0`);
